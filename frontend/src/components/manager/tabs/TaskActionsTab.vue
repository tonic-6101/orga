  ...
  <div class="space-y-6">
    ...
    <div>
      <h5 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3 flex items-center gap-2">
        <ToggleRight class="w-3.5 h-3.5 text-accent-500" aria-hidden="true" />
        {{ __('Change Status') }}
      </h5>
        ...
        <button
          ...
          :class="[
            ...
            task.status === col.id
              ...
              : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-700 hover:border-accent-500 hover:text-accent-500'
          ]"
        >
          {{ col.title }}
        </button>
    ...
    <div>
      <h5 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3 flex items-center gap-2">
        <Flag class="w-3.5 h-3.5 text-accent-500" aria-hidden="true" />
        {{ __('Change Priority') }}
      </h5>
      <div class="flex flex-wrap gap-2">
        <button
    ...
    <div>
      <h5 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3 flex items-center gap-2">
        <Zap class="w-3.5 h-3.5 text-accent-500" aria-hidden="true" />
        {{ __('Quick Actions') }}
      </h5>
      <div class="space-y-2">
        <!-- Navigate to Task -->
        ...
        >
          <ExternalLink class="w-4 h-4 text-gray-400 dark:text-gray-500" aria-hidden="true" />
          <div>
        ...
        <button
          ...
          class="w-full flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-left"
        >
          <UserPlus class="w-4 h-4 text-gray-400 dark:text-gray-500" aria-hidden="true" />
          <div>
        ...
        <button
          ...
          class="w-full flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-left"
        >
          <Copy class="w-4 h-4 text-gray-400 dark:text-gray-500" aria-hidden="true" />
          <div>
        ...
        >
          <Trash2 class="w-4 h-4 text-red-500" aria-hidden="true" />
          <div>
...
import { ToggleRight, Flag, Zap, ExternalLink, UserPlus, Copy, Trash2 } from 'lucide-vue-next'
